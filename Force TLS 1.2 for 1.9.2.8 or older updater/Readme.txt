...
the files from https://github.com/UnknownShadow200/MCGalaxy/tree/master/Uploads which is MCGalaxy.exe, MCGalaxyCLI.exe and MCGalaxy_.dll, place these files on the server folder and
